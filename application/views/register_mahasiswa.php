                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header justify-content-center"><h3 class="fw-light my-4">Create Account Mahasiswa</h3></div>
                                <div class="card-body">
                                    <!-- Registration form-->
                                    <form method="post" action="<?php base_url('register/register_mahasiswa') ?>">
                                        <!-- Form Row-->
                                        <div class="row gx-3">
                                            <!-- Form Group (NIM) -->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputNim">NIM</label>
                                                <input class="form-control" id="inputNim" type="text" name="username" placeholder="Masukkan NIM Mahasiswa" />
                                                <?php echo form_error('username', '<div class="text-danger small ml-3 mt-1">','</div>'); ?>
                                            </div>
                                            <!-- Form Group (Nama Mahasiswa) -->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputNamaMahasiswa">Nama Mahasiswa</label>
                                                <input class="form-control" id="inputNamaMahasiswa" type="text" name="nama" placeholder="Masukkan Nama Mahasiswa" />
